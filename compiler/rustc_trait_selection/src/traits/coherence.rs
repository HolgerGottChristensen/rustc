...
use rustc_middle::ty::{self, HKTSubstType, ImplSubject, Ty, TyCtxt, TypeVisitor};
...
fn with_fresh_ty_vars<'cx, 'tcx>(
    ...
    let header = ty::ImplHeader {
        impl_def_id,
        self_ty: tcx.bound_type_of(impl_def_id).subst(tcx, impl_substs, HKTSubstType::SubstHKTParamWithType),
        trait_ref: tcx.bound_impl_trait_ref(impl_def_id).map(|i| i.subst(tcx, impl_substs, HKTSubstType::SubstHKTParamWithType)),
