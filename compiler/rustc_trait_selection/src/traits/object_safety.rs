...
use rustc_middle::ty::{self, EarlyBinder, HKTSubstType, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable, TypeVisitor};
...
fn receiver_for_self_ty<'tcx>(
    ...
    let result = EarlyBinder(receiver_ty).subst(tcx, substs, HKTSubstType::SubstHKTParamWithType);
    debug!(
